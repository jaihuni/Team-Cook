...
Our goal for next two weeks is to improve the learnability of our site, focusing on the typical and most frequent user scenario. To do so, we will resolve the most critical usability problems mentioned above, while removing redundant elements that can confuse user.
